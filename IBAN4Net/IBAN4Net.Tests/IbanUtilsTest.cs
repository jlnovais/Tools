...
namespace IBAN4Net.Tests
{
    ...
    public class IbanUtilsTest
    {
        ...
        public void IbanValidationWithEmptyIBANShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) IbanFormatViolation.IBAN_NOT_EMPTY_OR_NULL, iex.FormatViolation );
            }
        }
        ...
        public void IbanValidationWithOneCharStringSHouldThrowEception()
        {
            ...
            {
                Assert.AreEqual( (object) IbanFormatViolation.COUNTRY_CODE_TWO_LETTERS, iex.FormatViolation );
            }
        }
        ...
        public void IbanValidationWithCountryCodeOnlyShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) IbanFormatViolation.CHECK_DIGIT_TWO_DIGITS, iex.FormatViolation );
            }
        }
        ...
        public void IbanValidationWithNonDigitCheckDigitShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) IbanFormatViolation.CHECK_DIGIT_ONLY_DIGITS, iex.FormatViolation );
            }
        }
        ...
        public void IbanValidationWithCountryCodeAndCheckDigitOnlyShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) IbanFormatViolation.BBAN_LENGTH, iex.FormatViolation );
            }
        }
        ...
        public void IbanValidationWithLowercaseCountryCodeShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) IbanFormatViolation.COUNTRY_CODE_UPPER_CASE_LETTERS, iex.FormatViolation );
            }
        }
        ...
        public void IbanValidationWithNonExistingCountryShouldThrowExeption()
        {
            ...
            {
                Assert.AreEqual( (object) IbanFormatViolation.COUNTRY_CODE_EXISTS, iex.FormatViolation );
            }
        }
        ...
        public void IbanValidationWithInvalidBankCodeShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) IbanFormatViolation.BBAN_ONLY_DIGITS, iex.FormatViolation );
            }
        }
        ...
        public void IbanValidationWithInvalidNationalCheckDigitShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) IbanFormatViolation.BBAN_ONLY_UPPER_CASE_LETTERS, iex.FormatViolation );
            }
        }
        ...
        public void IbanUtilChangeAccountNumberWithTooLongNumberShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) IbanFormatViolation.BBAN_ENTRY_TOO_LONG, iex.FormatViolation );
            }
        }
