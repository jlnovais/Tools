...
namespace IBAN4Net.Tests
{
    ...
    public class IbanTest
    {
        ...
        public void IbanTooLongAccountNumberShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) IbanFormatViolation.ACCOUNT_NUMBER_TOO_LONG, iex.FormatViolation );
            }
        }
        ...
        public void IbanShortAccountNumberWithoutAutoPaddingshouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) IbanFormatViolation.ACCOUNT_NUMBER_TOO_SHORT, iex.FormatViolation );
            }
        }
        ...
        public void IbanShortAccountNumberPrefixWithoutAutoPaddingShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) IbanFormatViolation.ACCOUNT_NUMBER_PREFIX_TOO_SHORT, iex.FormatViolation );
            }
        }
