...
namespace IBAN4Net.Tests
{
    ...
    public class BicUtilsTest
    {
        ...
        public void BicValidationWithLessCharactersShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) BicFormatViolation.BIC_LENGTH_8_OR_11, bex.FormatViolation );
            }
        }
        ...
        public void BicValidationWithLowercaseCharactersShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) BicFormatViolation.BIC_ONLY_UPPER_CASE_LETTERS, bex.FormatViolation );
            }            
        }
        ...
        public void BicValidationWithInvalidBankCodeShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) BicFormatViolation.BANK_CODE_ONLY_LETTERS, bex.FormatViolation );
            }
        }
        ...
        public void BicValidationWithInvalidCountryCodeShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) BicFormatViolation.COUNTRY_CODE_ONLY_UPPER_CASE_LETTERS, bex.FormatViolation );
            }
        }
        ...
        public void BicValidationWithInvalidBranchCodeShouldThrowException()
        {
            ...
            {
                Assert.AreEqual( (object) BicFormatViolation.BRANCH_CODE_ONLY_LETTERS_OR_DIGITS, bex.FormatViolation );
            }
        }
